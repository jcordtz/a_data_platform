...
At this stage, performance, stability, and semantic consistency are paramount. Hence the concept of a *<u>dataset</u>* *only* having the rows and columns needed to fulfill that task in question is important - not only from a governance perspective but also from a performance perspective.
